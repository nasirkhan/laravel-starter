        ...
        >
            ...
            >
                ...
                <a
                    ...
                    wire:navigate
                >
                    <span class="flex h-10 items-center justify-center rounded-md">
                        <x-cube::application-logo class="mr-2 h-7 rounded fill-current text-white" />
                    </span>
                ...
                <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    ...
                    >
                        <span class="flex items-center justify-center rounded-md">
                            <x-cube::application-logo class="h-10 fill-current text-black dark:text-white" />
                        </span>
