<div>
    ...
    <section class="bg-white text-gray-600 p-6 sm:p-20 mx-auto max-w-screen-xl">
        <div class="grid grid-cols-1">
            ...
            <p>
                These terms and conditions outline the rules and regulations for the use of {{ $company_name }}'s Website, located at {{ config('app.url') }}.
            </p>
            <p>
            ...
            <p>
                We employ the use of cookies. By accessing {{ app_name() }}, you agreed to use cookies in agreement with the {{ $company_name }}'s Privacy Policy.
            </p>
            <p>
            ...
            <p>
                Unless otherwise stated, {{ $company_name }} and/or its licensors own the intellectual property rights for all material on {{ app_name() }}. All intellectual property rights are reserved. You may access this from {{ app_name() }} for your own personal use subjected to restrictions set in these terms and conditions.
            </p>
            <p>
                You must not:
            </p>
            ...
            <p>
                Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. {{ $company_name }} does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of {{ $company_name }},its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, {{ $company_name }} shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
            </p>
            <p>
            ...
            <p>
                No use of {{ $company_name }}'s logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
