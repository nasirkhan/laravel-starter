<div>
    <div class="container mx-auto flex w-full flex-col items-center justify-center">
        <div class="mb-2 w-full rounded-md border bg-white px-4 py-5 shadow sm:px-6">
        ...
        <ul class="flex flex-col w-full">
            @foreach ($recentPosts as $row)
                ...
                <li class="mb-2 flex flex-row border-gray-400">
                    <div
                        class="flex flex-1 justify-between transform cursor-pointer select-none items-center rounded-md bg-white p-4 shadow transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg">
                        <div class="flex ">
                            <div class="mr-4 flex h-10 flex-col items-center justify-center">
                                <a class="relative block" href="{{ $details_url }}">
                                    <img class="mx-auto h-10 rounded object-cover" src="{{ $row->image }}"
                                        alt="{{ $row->name }}" />
                                </a>
                            </div>
                            <div class="pl-1">
                        ...
                        <button class="flex w-6 justify-end text-right">
                            <svg class="text-gray-500 hover:text-gray-800" width="12" fill="currentColor"
                                height="12" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                <path
