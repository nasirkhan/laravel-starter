    ...
    <div class="container mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div class="mb-10 sm:grid sm:grid-cols-3 sm:gap-6">
            <div class="sm:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-xl leading-6 font-semibold text-gray-800 dark:text-gray-200">
                        @lang("Edit Profile")
                    </h3>
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    required
                                    class="mt-1 w-full rounded-sm border border-gray-300 bg-white px-4 py-2 text-gray-700 placeholder-gray-300 shadow-sm focus:border-transparent focus:ring-2 focus:ring-blue-600 focus:outline-hidden dark:bg-gray-100"
                                />
                                @error("first_name")
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select
                                    wire:model="gender"
                                    id="gender"
                                    class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-3 shadow-sm focus:border-blue-500 focus:ring-blue-500 focus:outline-hidden sm:text-sm dark:bg-gray-100"
                                >
        ...
        <div class="mt-10 mb-10 sm:mt-0">
            <div class="sm:grid sm:grid-cols-3 sm:gap-6">
                <div class="sm:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg leading-6 font-medium text-gray-800 dark:text-gray-200">Account Settings</h3>
