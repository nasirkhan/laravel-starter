    ...
    <div class="card mb-4">
        <div class="card-body">
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    <a href="{{ route("backend.$module_name.markAllAsRead") }}" class="btn btn-outline-success mb-1"
                        data-toggle="tooltip" title="@lang('Mark all as read')"><i class="fas fa-check-square"></i>
                        @lang('Mark all as read')</a>
                    <a href="{{ route("backend.$module_name.deleteAll") }}" class="btn btn-outline-danger mb-1"
