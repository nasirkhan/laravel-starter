    ...
    <section class="bg-gray-50 pb-20 dark:bg-gray-700">
        <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
            <div class="rounded-lg p-3 shadow-lg dark:bg-gray-800 sm:p-10">
                <img src="https://github.com/nasirkhan/laravel-starter/assets/396987/b9ca9cd8-fa7c-43f0-b54f-47e7c4966d9c"
                    alt="Page preview">
            </div>
            <div class="row-span-2 rounded-lg p-3 shadow-lg dark:bg-gray-800 sm:p-10">
                <img src="https://github.com/nasirkhan/laravel-starter/assets/396987/b067e211-1208-49a6-859b-7a6810e3f3bb"
                    alt="Page preview">
            </div>
            <div class="rounded-lg p-3 shadow-lg dark:bg-gray-800 sm:p-10">
                <img src="https://github.com/nasirkhan/laravel-starter/assets/396987/413b3c75-4a1f-47e3-8885-bc6bd475213c"
                    alt="Page preview">
            </div>
        </div>
    </section>
