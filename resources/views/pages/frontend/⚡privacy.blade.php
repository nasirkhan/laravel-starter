...
new #[Layout('layouts::frontend')] #[Title('Privacy Policy')] class extends Component {
    ...
    <section class="mx-auto max-w-screen-xl bg-white p-6 text-gray-600 sm:p-20">
        <div class="grid grid-cols-1">
            <p>
                ...
                of information that is collected and recorded by {{ app_name() }} and how we use it.
            </p>
            <p>
                If you have additional questions or require more information about our Privacy Policy, do not hesitate
                to contact us through email at {{ $app_email }}
            </p>
            <p>
                This privacy policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in {{ app_name() }}. This policy is not
            ...
            <p>
                ...
                internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and
            ...
            <p>
                ...
                are used in their respective advertisements and links that appear on {{ app_name() }}, which are sent
            ...
            <p>
                Note that {{ app_name() }} has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>
