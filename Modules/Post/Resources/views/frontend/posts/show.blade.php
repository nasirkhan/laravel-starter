    ...
    <section class="body-font bg-gray-100 px-6 text-gray-600 dark:bg-gray-800 dark:text-gray-400 sm:px-20">
        <div class="container mx-auto flex flex-col items-center py-8 sm:py-16 md:flex-row">
            ...
            <div class="mb-4 w-full sm:mb-0 sm:w-8/12">
                <img class="rounded object-cover object-center shadow-md" src="{{ $$module_name_singular->image }}"
                    ...
                    <div class="flex flex-row content-center items-center justify-around">
                        ...
                        <div>
                            ...
                            <button
                                ...
                                data-via="muktolibrary" data-title="{{ $title_text }}" data-hashtags="muktolibrary"
                                data-url="{{ url()->full() }}" data-toggle="tooltip" data-original-title="Share on Twitter"
                            ...
                            <button
                                ...
                                data-hashtag="muktolibrary" data-url="{{ url()->full() }}" data-toggle="tooltip"
