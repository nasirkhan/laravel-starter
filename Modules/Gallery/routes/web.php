...
* --------------------------------------------------------------------
*/
Route::group(['namespace' => '\Modules\Gallery\Http\Controllers\Frontend', 'as' => 'frontend.', 'middleware' => 'web', 'prefix' => ''], function () {
    /*
     *
     *  Frontend Galleries Routes
     *
     * ---------------------------------------------------------------------
     */
